...
<div id="mastContent">
                    ...
                    <div id="donateButton"  >
                    	<form  action="https://www.paypal.com/cgi-bin/webscr" method="post" style="background-color:transparent">
                            ...
                            <input  style="background-color:transparent" type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
                    ...
                    <ul id="topNav">
                        ...
                        <li class="space"> | </li>
                       <li><a href="<?php echo site_url();?>/access"><img src="<?php echo base_url();?>images/icons/disabled.gif"  width="32" height="32"></a></li>
                        <li class="space"> | </li>

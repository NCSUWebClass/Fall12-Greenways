				...
				?>
                    <span class="row">
                     		...
                     		<?php $phone = array('name' => 'phone',
										...
										?>
                  <?php /*?> <!--<span class="row"><p>Would you like to receive our newsletter?</p>
           				
                    <input type="radio" name="newsletter" value="yes" <?php echo set_radio('volunteer', 'yes', TRUE); ?> /> Yes
					<input type="radio" name="newsletter" value="no" <?php echo set_radio('volunteer', 'no', FALSE); ?> checked="checked" /> No
                     
                   
</span> 	--><?php */?>
                   <?php /*?><!-- <span class="row">
                    			<p>Phone number:</p> <?php echo form_input($phone); ?>
                    </span>
                    ...
                    <span class="row">
                                <p>Location: (postal address or city or county)</p>
                                <?php echo form_textarea($address); ?>
                    </span>
                    <span class="row">
                    <?php $greenway = array('name' => 'greenway',
											'id' => 'greenway',
											'value' => set_value('greenway'),
											'size' => '35',
											'class' => 'colorField'
											);	
										?>
                                <p>If commenting on a trail, which trail?</p>
                                 <?php echo form_input($greenway); ?></span>--><?php */?>
                    		<?php $message = array(
									'name' => 'message',
									'id' => 'message',
                    ...
                    <span class="row"><p>Add a caption for the photo:</p>
                     ...
                     <span class="row">
                     		<img src="<?php echo base_url();?>captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaImg' >

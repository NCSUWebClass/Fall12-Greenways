package wsGreenways.testdatagenerators;

import java.io.FileNotFoundException;
import java.io.IOException;
import java.sql.SQLException;
import wsGreenways.DBBuilder;
...
public class TestDataGenerator {
	...
	public void greenways() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/greenways.sql");
	}

	public void events() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/events.sql");
	}
